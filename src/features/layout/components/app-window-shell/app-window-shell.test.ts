...
import { shouldRenderOverlayTitlebar } from "@/features/layout/components/app-window-titlebar-policy";
...
describe("AppWindowShell platform chrome", () => {
  ...
  it("keeps the Tauri drag-region element behind the macOS-only guard", () => {
    const source = readFileSync(
      resolve("src/features/layout/components/app-window-shell/app-window-shell.tsx"),
      "utf8",
    );
