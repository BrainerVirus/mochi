...
export function trayPanelShellClassName(): string {
  return "tray-panel text-foreground flex h-full max-h-[calc(100svh-16px)] min-h-0 w-full flex-1 flex-col overflow-hidden rounded-[var(--radius-tray-panel)] pt-3";
}
