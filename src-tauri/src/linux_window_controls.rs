...
pub fn prepare_decorated_window(
    ...
    #[cfg(target_os = "linux")]
    {
        LinuxWindowControlDiagnostics {
            ...
            decorations_action: "linux_builder_decorations".to_string(),
            decorations_error: None,
            decorations_ok: true,
            resizable_action: "linux_builder_resizable".to_string(),
...
mod tests {
    ...
    fn linux_window_control_diagnostics_serializes_actions_and_errors() {
        ...
        assert_eq!(value["decorations_action"], "linux_builder_decorations");
        assert_eq!(value["decorations_error"], serde_json::Value::Null);
        assert_eq!(value["resizable_action"], "linux_builder_resizable");
